...
def get_temperature(weatherinstance):
    return weatherinstance["temp_C"] + "°C" if temp_unit == "c" else weatherinstance["temp_F"] + "°F"

def get_temperature_hour(weatherinstance):
    return weatherinstance["tempC"] + "°C" if temp_unit == "c" else weatherinstance["tempF"] + "°F"

def get_feels_like(weatherinstance):
    return weatherinstance["FeelsLikeC"] + "°C" if temp_unit == "c" else weatherinstance["FeelsLikeF"] + "°F"

def get_wind_speed(weatherinstance):
    return weatherinstance["windspeedKmph"] + "Km/h" if windspeed_unit == "km/h" else weatherinstance["windspeedMiles"] + "Mph"
